...
public class EmployeeStreamMain {
	...
	public static void main(String[] args) {
		...
		employees.add(new Employee(1, "Aryan", 22, "Male", "Senior Management", 2026, 700000));
		employees.add(new Employee(2, "Raj", 22, "Male", "Sales", 2025, 75000));
		employees.add(new Employee(3, "Aakash", 23, "Male", "Security", 2026, 5000));
		employees.add(new Employee(4, "Abhishek", 23, "Male", "Sales", 2023, 65000));
		employees.add(new Employee(5, "Kaushal", 35, "Female", "HR", 2020, 70000));
		employees.add(new Employee(6, "Abhijeet", 21, "Male", "Product Development", 2020, 15000));
